...
# Import data - cleaned
scop_orientation <- read_csv(scop_eds_orientation, "data/cleaned/cleaned_eds_orientation.csv")
scop_gender <- read_csv(scop_eds_gender, "data/cleaned/cleaned_eds_gender.csv")
scop_combined <- read_csv(scop_eds_combined_1, "data/cleaned/cleaned_eds_combined.csv")
